...
// ---------------------------------------------------------------------------
// Nav sections — must match section anchor IDs in primitives.index.tsx
// ---------------------------------------------------------------------------
const NAV_ITEMS = [
  { id: 'tabs', label: 'Tabs' },
...
// Layout
// ---------------------------------------------------------------------------
function PrimitivesLayout() {
  // Dark mode toggle — no useEffect; derives from classList at init time
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        {/* Content — Outlet renders primitives.index.tsx */}
        <ScrollArea className="flex-1">
