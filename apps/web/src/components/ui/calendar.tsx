    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          'h-7 w-7 bg-transparent text-neutral-500',
        ...
        weekdays: 'flex',
        weekday: 'text-neutral-400 rounded-md w-9 font-normal text-[0.8rem] text-center',
        weeks: '',
        ...
        today: '[&>button]:bg-neutral-100 [&>button]:text-neutral-900 [&>button]:font-semibold',
        outside: '[&>button]:text-neutral-300 [&>button]:opacity-50',
        disabled: '[&>button]:text-neutral-300 [&>button]:opacity-40 [&>button]:cursor-not-allowed',
