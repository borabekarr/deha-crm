...
// Prototype: full-width, rounded-[14px], white bg, slate-200 border,
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDownIcon className="ml-2 size-4 shrink-0 text-slate-500 transition-transform duration-[var(--duration-fast,120ms)] group-data-[state=open]:rotate-180" />
...
// Prototype: white bg, rounded-[12px], slate-200 border, strong overlay shadow,
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      'px-3 py-1.5 text-xs font-700 text-slate-400 uppercase tracking-[0.08em]',
      className,
    )}
    {...props}
  />
...
// Prototype: py-2 px-3, text-14 font-500 slate-700, hover slate-50 slate-900,
