      ...
      <div className="shell sel-shell" data-screen-label="AI Model Selection Sheet">
        <div className="sheet" ref={sheetRefWithCleanup as React.RefCallback<HTMLDivElement>}>
          ...
          <div className="sh-head">
            <button type="button" className="nav-btn" id="mss-prevBtn" aria-label="Previous model">
            ...
            <button type="button" className="nav-btn" id="mss-nextBtn" aria-label="Next model">
          ...
          <div className="sh-body">
            ...
            {/* confirm */}
            <button type="button" className="confirm" id="mss-confirmBtn">
              <span
