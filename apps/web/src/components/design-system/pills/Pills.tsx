...
import './Pills.css'
import { usePillIndicator } from './pills-hook'

type SegOption = 'Daily' | 'Weekly' | 'Monthly'

const SEG_OPTIONS: SegOption[] = ['Daily', 'Weekly', 'Monthly']

export default function Pills() {
  const [seg, setSeg] = useState<SegOption>('Daily')
  const segRef = useRef<HTMLDivElement>(null)
  const activeIdx = SEG_OPTIONS.indexOf(seg)
  const pos = usePillIndicator(activeIdx, segRef)
  ...
  return (
    <div className="card">
      ...
      <div className="pills-row">
        <div className="pills-seg" ref={segRef}>
