...
export default function IndexBar() {
  ...
  function play() {
    ...
    // play bars
    if (barsRef.current && sweepRef.current) {
      playBars(barsRef.current, sweepRef.current)
    }
  }
        ...
        <div className="idx">
          ...
          <div className="idx-card">
            <div className="idx-metrics">
              {METRICS.map((_, i) => (
                <MetricCard key={i} index={i} onPlay={registerPlayer(i)} />
              ))}
            </div>
            ...
            <div className="idx-funnel">
              ...
              <div className="idx-bars-wrap">
                ...
                <div className="idx-sweep" ref={sweepRef} />
              </div>
