...
function PrizeContent() {
  return (
    <>
      ...
      <button className="claim-btn" data-claim>
    ...
    <div className="demo">
      ...
      <div className="ps-device" ref={deviceRef}>
        ...
        <div className="ps-screen">
          ...
          <button className="ps-fab" ref={fabRef}>
