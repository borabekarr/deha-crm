...
export default function FinancialHealthCard() {
  ...
  const cardCallbackRef = useCallback((el: HTMLDivElement | null) => {
    cardRef.current = el
    if (el) {
      // refs to children may not be set yet; schedule micro-task to let React
      // finish rendering children first
      queueMicrotask(() => {
  ...
  return (
    <div className="fhc-frame">
            ...
            <div className="fhc-info-body">
              <div className="fhc-info-inner">
                <div className="fhc-sec" style={{ '--s': 0 } as React.CSSProperties}>
                  <div className="fhc-sec-h">Why?</div>
                ...
                <div className="fhc-sec" style={{ '--s': 1 } as React.CSSProperties}>
                  <div className="fhc-sec-h">Recommendation:</div>
      ...
      <div className="fhc-controls">
        <button className="fhc-btn" onClick={handleReplay}>
          <span className="material-icons">replay</span>Replay load
        </button>
        <button className="fhc-btn" onClick={() => handleSetScore(34)}>
          <span className="material-icons">south</span>Score 34
        </button>
        <button className="fhc-btn" onClick={() => handleSetScore(62)}>
          <span className="material-icons">remove</span>Score 62
        </button>
        <button className="fhc-btn" onClick={() => handleSetScore(90)}>
