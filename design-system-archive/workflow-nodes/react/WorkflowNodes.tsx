...
function NodeTools(): React.ReactElement {
  return (
    <div className="wf-tools">
      <button className="wf-tool connect" data-tip="Connect to next" aria-label="Connect to next node" />
      <button className="wf-tool add" data-tip="Add next" aria-label="Add next node">
        <span className="material-icons">add</span>
      </button>
      <button className="wf-tool edit" data-tip="Rename" aria-label="Rename node">
        <span className="material-icons">edit</span>
      </button>
      <button className="wf-tool del tip-bottom" data-tip="Delete" aria-label="Delete node">
