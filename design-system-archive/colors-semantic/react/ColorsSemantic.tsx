...
export default function ColorsSemantic() {
  return (
    <div className="card">
      <div className="grid4">
        <div className="sem" style={{ background: '#ECFDF5', color: '#047857' }}>
        ...
        <div className="sem" style={{ background: '#FEFCE8', color: '#854D0E' }}>
        ...
        <div className="sem" style={{ background: '#FEF2F2', color: '#B91C1C' }}>
        ...
        <div className="sem" style={{ background: '#FFF7ED', color: '#C2410C' }}>
