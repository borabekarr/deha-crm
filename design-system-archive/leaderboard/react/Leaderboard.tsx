...
export default function Leaderboard() {
  ...
  const segCallbackRef = useCallback((el: HTMLDivElement | null) => {
    if (el) {
      ...
      // Arm pill transition after 60ms (same as prototype)
      const t = setTimeout(() => setArmed(true), 60)

      // Store extra cleanup on the element
      const prev = (el as HTMLDivElement & { __lbArmedCleanup?: () => void }).__lbArmedCleanup
      prev?.()
      ;(el as HTMLDivElement & { __lbArmedCleanup?: () => void }).__lbArmedCleanup = () => clearTimeout(t)
    } else {
        ...
        <div className="lb">
          <div className="head">
            ...
            <div
              ...
              ref={segCallbackRef}
            >
              <span className="seg-pill" style={pillStyle} />
              <button
